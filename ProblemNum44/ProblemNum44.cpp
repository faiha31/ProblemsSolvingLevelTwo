...
int CountPositiveNumbersInArrayElement(int arr[100], int& NumberOfElemnts)
{
    int Count = 0;
...
int main()
{
    ...
    cout << endl << "Array1 Positive Numbers Count is : "
        << CountPositiveNumbersInArrayElement(arr1, Arr1Length) << endl;
