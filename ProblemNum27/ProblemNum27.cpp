...
then print the average (arithmetic mean) of the numbers.*/
...
int SumElementsInArray(int arr[100], int NumberOfElemnts)
{
...
float AvgElementsInArray(int arr[100], int NumberOfElemnts)
{

    return (float) SumElementsInArray(arr, NumberOfElemnts)/ NumberOfElemnts;
}
int main()
{
    ...
    cout << "\n The average of the numbers : " << AvgElementsInArray(arr, NumberOfElemnts);
