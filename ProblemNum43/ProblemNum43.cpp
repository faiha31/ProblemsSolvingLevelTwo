...
int CountEvenNumbersInArrayElement(int arr[100], int& NumberOfElemnts)
{
    int Count = 0;
...
int main()
{
    ...
    cout << endl << "Array1 Even Numbers Count is : "
        << CountEvenNumbersInArrayElement(arr1, Arr1Length) << endl;
